              ...
              <div className="flex items-start justify-start w-[100%]">
                <div className="flex flex-col gap-[24px] items-start justify-start w-[100%]">
                  ...
                  <div className="flex flex-row gap-[12px] items-start justify-start w-[100%]">
                    <Button className="border-[1px] border-gray_600 border-solid cursor-pointer flex-1 font-bold sm:px-[20px] px-[24px] py-[21px] rounded-[10px] text-[18px] text-center text-gray_900 w-[60px]">
                      0
                    </Button>
                    <Button className="border-[1px] border-gray_600 border-solid cursor-pointer flex-1 font-bold sm:px-[20px] px-[24px] py-[21px] rounded-[10px] text-[18px] text-center text-gray_900 w-[60px]">
                      0
